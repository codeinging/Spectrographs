package com.icephone.mphone.spectrograph.ui.widget;
/*
 * UVCCamera
...
public class UVCCameraTextureView extends TextureView    // API >= 14
        implements AspectRatioViewInterface, TextureView.SurfaceTextureListener {
    private double mRequestedAspect = -1.0;
    private String TAG = "UVCCameraTextureView";
...
//        Logger.w("height:" + getBitmap().getHeight());
        if (listener!=null){
            listener.onUpdate(getBitmap());
        }
